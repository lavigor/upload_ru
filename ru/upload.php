...
$lang = array_merge($lang, array(
	...
	'VALID_PHPBB_EXTENSIONS_TITLE'		=> 'Вы можете загружать расширения с официального сайта phpbb.com, а также проверять информацию об их обновлениях.<br />ПРИМЕЧАНИЕ: актуальность списка расширений на данный момент обеспечивают разработчики Загрузки Расширений.',
